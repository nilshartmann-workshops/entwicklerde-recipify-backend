...
public record DetailedRecipeDto(@JsonUnwrapped @Valid RecipeDto recipe,
                                @Valid @NotNull List<Instruction> instructions,
                                @Valid @NotNull List<Ingredient> ingredients) {
